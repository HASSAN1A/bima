        ...
        <div class="banner-content-item banner-content-item-left">
          <div class="banner-des-box">
            ...
            <div class="banner-button-wrapper">
              ...
              <div class="banner-button">
                <a target="_blank" href="https://buy.bima.network/#/">MVP on Rinkeby</a>
              </div>
              <div class="banner-button">
                <a target="_blank" href="https://staking.bima.network/#/">Underwriter Program</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="content-item">
          <el-card class="box-card">
            <div class="content-item-box">
              ...
              <p>Provide capital to back insurance risks in the capital pool, or purchase insurance covers to obtain Bima tokens. Bima are minted and automatically awarded on every block.</p>
              <div class="img-box">
        ...
        <div class="content-item">
          <el-card class="box-card">
            <div class="content-item-box">
              ...
              <p>Bima.Network is a permissionless platform for whoever wants to purchase a cover. Capital providers can utilize Bima to stake on specific insurance risks to obtain daily insurance premiums. Leverage staking is available for non-correlated insurance products.</p>
              <div class="img-box">
...
<script>
  ...
  data() {
    return {
      tips: 'Beware of Any Scam Attempts. $BIMA token has not been deployed yet. Any pools found are impersonations and SCAM ATTEMPTS. Do not engage with such.',
      roadmap: [
        {
          time: '2020Q1',
        ...
        {
          time: '2021Q2',
          list: ['bima DAO support; Community governance']
        },
        {
          time: '2021Q3',
        ...
        {
          time: '2021Q4',
          list: ['Developing strategies to deliver greater returns to bima holders']
        },
      ],
      team: [
        {
